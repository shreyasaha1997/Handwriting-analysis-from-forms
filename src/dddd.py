...
class DataLoader:
    ...
    def __init__(self, filePath, batchSize, imgSize, maxTextLen):
        ...
        uppercase_characters = '../data/hsf_'
        lowercase_characters = '../data/hsf_'
        chars = set()
        numbers = '../data/hsf_'

        for directories in range(0,7):
            for folders in range(1, 27):
                uc = uppercase_characters +str(directories) + '/' + str(folders) + '/'
                lc = lowercase_characters +str(directories) + '/' + str(folders) + '/'
            ...
            for folders in range(0, 10):
                npath = numbers + +str(directories) + '/' + str(folders) + '/'
